...
ui <- fluidPage(
  ...
  # title
  titlePanel("Risk of (mass-gathering) events under COVID-19"),
  ...
  mainPanel(
    ...
    numericInput("attend", 
                 label = h3("Expected attendees in the event"), 
                 value = 100,
                 min=0),
    ...
    numericInput("target", 
                 label = h4("The probability that the number (input value below) of infectious people will attend in the event will be calculated in the results"), 
                 value = 10,
                 min=0),
    ...
    br(),
    h3("RESULTS:"),
    h4("Probability that there will be at least one infectious person in the event:"),
    h1(textOutput("outresult1")),
    br(),
    h4("Expected number of infectious people in the event:"),
    h1(textOutput("outresult2")),
    br(),
    h4("Probability that there will be "),    
    h4(textOutput("outtarget1")),
    h4("or more infectious people in the event:"),
    ...
    br(),
    helpText("Created 15/Nov/2020, Updated 15/Nov/2020"),
  ...
  sidebarPanel(
    ...
    helpText("Default = 7"),
    helpText('Not from "onset" but from "infection." FYI, interval from "infection" to "onset" is 4-5 days on average'),    
    helpText("The parameter depends on testing capacity and strategy"),    
