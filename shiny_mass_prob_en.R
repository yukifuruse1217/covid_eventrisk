...
ui <- fluidPage(
  ...
  mainPanel(
    ...
    radioButtons("screen", 
                 label = h4("Will a screening about the presence of symptoms be conducted? (Are people with symptoms NOT allowed to attend?)"), 
                 choices = list("Yes" = 1, 
                                "No" = 2),
                 selected = 1),
    ...
    h4("or more infectious people at the event:"),
