...
ui <- fluidPage(
  ...
  sidebarPanel(
    ...
    helpText("初期設定 = 4"),
    helpText("「発症から」ではありません。参考までに、「感染から発症まで」はオミクロン株で一般的に２～３日です"),    
    helpText("この値は、地域の検査状況によって大きく異なる可能性があります"),    
